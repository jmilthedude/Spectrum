package net.thedudemc.spectrum.common.item;
...
public class ItemDyeingTable extends Item {
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (worldIn.isRemote) {
			...
			if (placeable) {
				worldIn.setBlockState(pos, SpectrumBlocks.DYEING_TABLE.getDefaultState().withProperty(BlockDyeingTable.FACING, enumFacing).withProperty(BlockDyeingTable.PART, BlockDyeingTable.EnumPart.ITEM_OUT));
				worldIn.setBlockState(side, SpectrumBlocks.DYEING_TABLE.getDefaultState().withProperty(BlockDyeingTable.FACING, enumFacing).withProperty(BlockDyeingTable.PART, BlockDyeingTable.EnumPart.FLUID_IN));
				worldIn.setBlockState(upLeft, SpectrumBlocks.DYEING_TABLE.getDefaultState().withProperty(BlockDyeingTable.FACING, enumFacing).withProperty(BlockDyeingTable.PART, BlockDyeingTable.EnumPart.CONTROLLER));
